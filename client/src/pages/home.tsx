            ...
            >
              ...
              >
                ...
                <span className="text-balance">
                  {" "}
                  marketed with taste, sold with precision.
                </span>
              </h1>
              ...
              >
                We’re a three-agent team at The Grubb Company focused on Oakland’s
                most enduring neighborhoods—Crocker Highlands and Trestle Glen—serving
                Piedmont and Berkeley as well.
              </p>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-1">
                      <div
                        ...
                        data-testid="text-signal-title-1"
                      >
                      ...
                      >
                        Warm editorial photography, clean typography, and story-led
                        property pages.
                      </div>
                    </div>
                    <div className="space-y-1">
                      <div
                        className="text-sm font-medium"
                        data-testid="text-signal-title-2"
                      >
                        Pricing with proof
                      </div>
                      <div
                      ...
                      >
                        Data-informed positioning + local buyer behavior, explained in
                        plain English.
                      </div>
                    </div>
                    <div className="space-y-1">
                      <div
                        className="text-sm font-medium"
                        data-testid="text-signal-title-3"
                      >
                      ...
                      >
                        Major sponsors of Crocker Highlands Elementary; active with the
                        PTA.
                      </div>
                    </div>
                  </div>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            {neighborhoods.map((n) => (
              <Card
                ...
                data-testid={`card-neighborhood-${n.title
                  .replace(/\s+/g, "-")
                  .toLowerCase()}`}
              >
                ...
                <div className="mt-5">
                  <Link href="/blog">
                    <a
                      className="inline-flex items-center justify-center rounded-full border bg-background px-4 py-2 text-sm transition-colors hover:bg-muted"
                      data-testid={`link-neighborhood-${n.title
                        .replace(/\s+/g, "-")
                        .toLowerCase()}`}
                    >
                      Explore Q&A
        ...
        <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
          <div className="grid gap-8 md:grid-cols-12 md:items-end">
            <div className="md:col-span-5">
              ...
              >
                We’re a boutique team within The Grubb Company—high-touch,
                design-forward, and deeply local.
              </p>
            </div>
            <div className="md:col-span-7">
              <Card className="rounded-3xl border bg-card p-6">
                <div className="text-sm text-muted-foreground">
                  Expect weekly Q&A posts, neighborhood guides, and market explainers—written
                  for buyers and sellers who want clarity.
                </div>
            ...
            {team.map((m) => (
              ...
              >
                ...
                <div
                  ...
                  data-testid={`text-team-name-${m.name
                    .replace(/\s+/g, "-")
                    .toLowerCase()}`}
                >
                  {m.name}
                ...
                <p
                  className="mt-3 text-sm text-muted-foreground"
                  data-testid={`text-team-bio-${m.name
                    .replace(/\s+/g, "-")
                    .toLowerCase()}`}
                >
                  {m.bio}
                ...
                <div className="mt-5 flex gap-2">
                  <Button
                    variant="outline"
                    className="rounded-full"
                    data-testid={`button-team-email-${m.name
                      .replace(/\s+/g, "-")
                      .toLowerCase()}`}
                  >
                    Email
                  ...
                  <Button
                    variant="outline"
                    className="rounded-full"
                    data-testid={`button-team-call-${m.name
                      .replace(/\s+/g, "-")
                      .toLowerCase()}`}
                  >
                    Call
            ...
            <div className="grid gap-0 md:grid-cols-12">
              <div className="relative md:col-span-5">
                ...
                <div className="relative p-8">
                  ...
                  <p
                    className="mt-3 text-sm text-muted-foreground"
                    data-testid="text-community-body"
                  >
                    We’re major sponsors of Crocker Highlands Elementary School and
                    active with the PTA—because the best neighborhoods are built by
                    neighbors.
                  </p>
                  <div className="mt-6">
                    <Button
              ...
              <div className="md:col-span-7">
                <div className="p-8">
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    >
                      ...
                      <div className="mt-2 text-sm text-muted-foreground">
                        We understand school patterns, street-by-street character, and
                        what buyers value here.
                      </div>
                    </Card>
                    <Card
                      className="rounded-2xl border bg-background p-5"
                      data-testid="card-community-2"
                    >
                      ...
                      <div className="mt-2 text-sm text-muted-foreground">
                        Real relationships create authentic demand—not generic
                        impressions.
                      </div>
                    </Card>
                    <Card
                      className="rounded-2xl border bg-background p-5"
                      data-testid="card-community-3"
                    >
                      <div className="text-xs text-muted-foreground">For buyers</div>
                      <div className="mt-1 font-serif text-xl">Fast answers</div>
                      <div className="mt-2 text-sm text-muted-foreground">
                        Our Q&A library is built to answer the questions people actually
                        search.
                      </div>
                    </Card>
                    <Card
                      className="rounded-2xl border bg-background p-5"
                      data-testid="card-community-4"
                    >
                      <div className="text-xs text-muted-foreground">For sellers</div>
                      <div className="mt-1 font-serif text-xl">Polished process</div>
                      <div className="mt-2 text-sm text-muted-foreground">
                        Timing, pricing, prep, and storytelling—handled with clarity and
                        taste.
                      </div>
                    </Card>
                  </div>
                  ...
                  <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div
                      className="text-sm text-muted-foreground"
                      data-testid="text-community-cta"
                    >
